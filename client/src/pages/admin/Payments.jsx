    ...
    <div style={{ position: 'relative', minHeight: '100%' }}>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 16 }}>
          <div>
            <h1 style={{ fontSize: '1.8rem', fontWeight: 700, marginBottom: 4 }}>Financials</h1>
        ...
        <div className="grid-3">
          <div className="stat-card">
            ...
            <div>
              <div className="stat-value">₹{loading ? '...' : (stats.revenue || 0).toLocaleString('en-IN')}</div>
                ...
                {loading ? (
                  ...
                  filtered.map(tx => (
                    <tr key={tx._id} className="hoverable-row">
                      ...
                      <td className="text-muted" style={{ fontSize: '0.85rem' }}>{new Date(tx.createdAt).toLocaleDateString()}</td>
                      <td style={{ fontWeight: 700 }}>₹{(tx.amount || 0).toLocaleString('en-IN')}</td>
                      <td>
